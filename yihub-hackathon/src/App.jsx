...
import { Calendar, Clock, MapPin, Users, Code, Brain, Target, Rocket, Building2, Handshake, Mail, Phone, MapPinned, Github, Twitter, Instagram, Zap, Cpu, Sparkles } from 'lucide-react';
...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0F172A]">
        ...
        <div className="container mx-auto px-4 py-32 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-6">
              ...
              <button className="bg-white/5 backdrop-blur-sm text-white font-bold py-4 px-10 rounded-xl text-xl transition-all button-bounce border border-white/10 hover:bg-white/10">
                Learn More →
              </button>
            </div>
          </div>
      ...
      <div className="relative   p-8 bg-gray-900/90 backdrop-blur-lg   shadow-lg overflow-hidden">
      ...
      <ul className="space-y-4 relative">
        {schedule.map((item, index) => (
          <li 
            key={index} 
            className="flex items-center justify-between p-4 bg-white/10 rounded-lg border border-white/10 hover:bg-white/20 transition"
          >
            <span className="text-2xl font-bold mb-4 text-white">{item.time}</span>
            <span className="text-2xl  mb-4 text-white">{item.activity}</span>
          </li>
        ))}
      </ul>
      </div>
          ...
          <div className="grid md:grid-cols-3 gap-12 py-16">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><a href="#" className="text-gray-400 hover:text-blue transition-colors">About Us</a></li>
                <li><a href="#" className="text-gray-400 hover:text-blue transition-colors">Schedule</a></li>
                <li><a href="#" className="text-gray-400 hover:text-blue transition-colors">FAQs</a></li>
                <li><a href="#" className="text-gray-400 hover:text-blue transition-colors">Code of Conduct</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li className="flex items-center gap-2 text-gray-400">
                  ...
                  <a href="mailto:youthinnovatorshub@gmail.com" className="hover:text-blue transition-colors">youthinnovatorshub@gmail.com
</a>
                </li>
                <li className="flex items-center gap-2 text-gray-400">
                  <Phone className="w-5 h-5 text-blue" />
                  <a href="tel:+250780000000" className="hover:text-blue transition-colors">+250 791 845 268</a>
                </li>
                <li className="flex items-center gap-2 text-gray-400">
                  <MapPinned className="w-5 h-5 text-blue" />
